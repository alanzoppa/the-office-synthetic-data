...
BANK_REFLECT_MISSION = (
    "Transcripts of The Office (US) — all 186 episodes across 9 seasons. "
    "Each document is a full episode script with scenes and dialogue. "
    "Prioritize character relationships, recurring jokes, plot developments, "
    "memorable quotes, and character arcs across seasons."
)

# CRITICAL: retain_mission controls LLM entity subject assignment.
# Without it, the bank name leaks into experience entities.
BANK_RETAIN_MISSION = (
    "These are fictional TV episode transcripts from The Office (US). "
    "Extract facts about characters, their relationships, dialogue, and plot events. "
    "Use character names as entities (e.g., 'Michael', 'Jim', 'Pam', 'Dwight') — "
    "never use the bank name or document title as the subject. "
    "Focus on character interactions, recurring gags, story arcs, and notable scenes."
)
